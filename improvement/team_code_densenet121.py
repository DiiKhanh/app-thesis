...
def load_challenge_models(model_folder, verbose):
    model_folder = model_folder.lower()
    filename = hf_hub_download(repo_id=model_folder, filename="densenet121/models.sav")
    model = joblib.load(filename)
    file_path_eeg = hf_hub_download(repo_id=model_folder, filename="densenet121/eeg/checkpoint_best.pth")
    if USE_TORCH:
        print("Load model...")
